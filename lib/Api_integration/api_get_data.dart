...
class ApiAllGetData {
  static GetApiAllGetData(context, String? dateFrom, String? dateTo, var areaId,
      var bpId, var leaderId) async {
    String Link = "http://apps.bigerp24.com/api/get_data";
    List<DataLists> allGetDatalist = [];
    DataLists allDataListsClass;
    print(GetStorage().read("token"));

    print('datas are: ${dateFrom} jakjhdba ${dateTo}  djcbjhsc ${areaId} aaaaaa$bpId llllllll $leaderId');
    try {
      Response response = await Dio().post(Link,
          data: {
            ...
            "bpId": bpId != null ? int.parse("$bpId").toInt() : "",
            "leaderId": leaderId != null ? int.parse("$leaderId").toInt() : "",
          },
